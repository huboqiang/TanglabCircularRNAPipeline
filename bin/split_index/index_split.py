...
Example:
   python %s -t 10 -l 101 -b 1 test11.fq.gz test22.fq.gz TTAGGC,TGACCA,GCCAAT,CAGATC,ACTTGA,GATCAG
...
def main():
   ...
   shell_info = "/datc/huboqiang/cir_dyj_V2/bin/split_index/index_split -t %d -l %d -b %d %s %s %s" % ( phreads,read_leng,barcode_error,  infile_1,infile_2,bar_seq )
